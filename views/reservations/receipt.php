...
<body>
    ...
    <div class="data-info">
        <p><strong><?php echo $data['reservation']['identity_type']; ?>:</strong><?php echo $data['reservation']['client_identity']; ?></p>
        <p><strong>Nombre: </strong><?php echo $data['reservation']['name']; ?></p>
        <p><strong>Teléfono: </strong><?php echo $data['reservation']['phone']; ?></p>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left" colspan="2"><?php echo $data['reservation']['date_retirement']; ?></td>
            </tr>
        </tbody>
    </table>
    <div class="message">
