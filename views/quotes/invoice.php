...
<body>
        ...
        <tr>
            ...
            <td class="info-quote">
                <div class="cointainer-invoice">
                    <span class="invoice"><strong>Cotización</strong></span>
    ...
    <table id="container-info">
        <tr>
            <td>
                <strong><?php echo $data['quote']['identity_type'];?> :</strong>
                <p><?php echo $data['quote']['client_identity']; ?></p>
            </td>
            <td>
                <strong>Nombre: </strong>
                <p><?php echo $data['quote']['name']; ?></p>
            </td>
        </tr>
        <tr>
            <td>
                <strong>Teléfono: </strong>
                <p><?php echo $data['quote']['phone']; ?></p>
            </td>
            <td>
                <strong>Dirección: </strong>
                <p><?php echo $data['quote']['address']; ?></p>
            </td>
        </tr>
    </table>
    ...
    <table id="container-product">
        ...
        <tbody>
            ...
            // //Tax (IVA 19%) included
            // $subtotal = $data['quote']['total'] / 1.19;
            // $taxes = $data['quote']['total'] - $subtotal;
            // $totalWithoutDiscount = $data['quote']['total'] - $data['quote']['discount'];
            // $totalWithDiscount = $data['quote']['total'];

            //Tax (IVA 19%) NOT included
            $subtotal = $data['quote']['total'] - $data['quote']['discount'];
            $taxes = $subtotal * 0.19;
    ...
    <div class="paymentMethod">
        <p><strong>Método de pago: </strong><?php echo $data['quote']['method']; ?></p>
