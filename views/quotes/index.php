    ...
    <div class="card-body">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-quotes-tab" data-bs-toggle="tab" data-bs-target="#nav-quotes" type="button" role="tab" aria-controls="nav-quotes" aria-selected="true">Cotizaciones</button>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active p-3" id="nav-quotes" role="tabpanel" aria-labelledby="nav-quotes-tab" tabindex="0">
                <h5 class="card-title text-center"><i class="fa-solid fa-list-alt"></i> Nueva Cotización</h5>
                <hr>
                <div class="row mb-2">
                    <div class="col-md-6">
                ...
                <div class="table-responsive">
                    <!-- Products table -->
                    <table class="table table-bordered table-striped table-hover align-middle" id="tblNewQuote" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Producto</th>
                                <th>Precio</th>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group mb-2">
                            <label for="validity">Validez Oferta</label>
                        ...
                        <div class="d-grid">
                            <button class="btn btn-success" type="button" id="btnAction">Generar cotización</button>
                        </div>
                    </div>
                </div>
            </div>
